...
function loadChampionnat() {
    ...
    fetch(`https://api-football-v1.p.rapidapi.com/v3/players/topassists?league=${championnat}&season=2024`, options)
        .then(response => response.json())
        .then(json => {
            console.log(json);
            const tbody = document.querySelector('#topassists tbody');
